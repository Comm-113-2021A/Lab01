...
subtitle: "Due: 1 October, 16:00 UK time"
output: 
  tufte::tufte_html:
    css: lab.css
...
**!!!IMPORTANT!!!** Your repository is not the one called `homework`, that's where I write the homework instructions (like this document!).
